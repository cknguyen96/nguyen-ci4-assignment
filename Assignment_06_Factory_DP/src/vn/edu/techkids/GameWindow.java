...
public class GameWindow extends Frame implements Runnable {
    ...
    StrongBulletGiftController strongBulletGiftController;
    ...
    public GameWindow () {
        ...
        this.bombController = new BombController(new GameObject(600, 400, 40, 40),
                new ImageDrawer("resources/bomb.png")
        );
        this.strongBulletGiftController = new StrongBulletGiftController(new GameObject(200, 400, 40, 40),
                new ImageDrawer("resources/gift_bullet.png")
        );
...
//                }
    ...
    public void update(Graphics g) {
        ...
        strongBulletGiftController.paint(backbufferGraphics);
...
//                }
 //               plane2.run();
                ...
                bombController.run();
                strongBulletGiftController.run();

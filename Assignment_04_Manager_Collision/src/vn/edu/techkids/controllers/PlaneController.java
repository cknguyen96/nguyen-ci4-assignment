...
public class PlaneController extends SingleController implements Colliable{
    ...
    protected PlaneController(Plane gameObject, GameDrawer gameDrawer) {
        super(gameObject, gameDrawer);
        bulletControllerManager = new BulletControllerManager();
        CollisionPool.getInst().add(this);
        this.gameObject.setHP(DEFAULT_HP);
    }
    ...
    public void onCollide(Colliable c) {
        if(this.gameObject.getHP() == 0) this.gameObject.setAlive(false);
    }
